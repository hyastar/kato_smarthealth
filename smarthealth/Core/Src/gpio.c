...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, BLE_WUP_Pin|BLE_RELOAD_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : BLE_STA_Pin */
  GPIO_InitStruct.Pin = BLE_STA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(BLE_STA_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : BLE_WUP_Pin BLE_RELOAD_Pin */
  GPIO_InitStruct.Pin = BLE_WUP_Pin|BLE_RELOAD_Pin;
